...
public enum StyleDescription {
    ...
    CARTOON("The American cartoon style is characterized by bold lines, exaggerated features, and a more humorous, less realistic approach."),
    ...
    WEBTOON("The webtoon style should reflect the unique blend of realism and stylization found in Korean digital comics, with crisp lines, detailed expressions, and vibrant colors.");
